...
file_directory = '/Volumes/NO NAME/FS/Mempool Dumpster/May'
...
# Loop through the daily files of May 2024
for day in range(1, 32):
    file_name = f"2024-05-{day:02d}.csv"  # Format day as 01, 02, etc.
...
if dataframes:
    ...
    # Customisation 2
    plt.title("Daily Distribution of Transactions (May 2024)", fontsize=14)
