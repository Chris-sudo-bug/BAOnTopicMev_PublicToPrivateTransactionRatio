...
# -*- coding: utf-8 -*-
"""
Created on Wed Dec  4 01:34:52 2024
...
file_directory = '/Volumes/NO NAME/FS/Mempool Dumpster/June'
...
# Loop through the daily files of June 2024
for day in range(1, 31):
    file_name = f"2024-06-{day:02d}.csv"  # Format day as 01, 02, etc.
...
if dataframes:
    ...
    # Print the total rows in all files combined and the final concatenated DataFrame
    ...
    # Customisation 2
    plt.title("Daily Distribution of Transactions (June 2024)", fontsize=14)
