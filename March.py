...
# -*- coding: utf-8 -*-
"""
Created on Wed Dec  4 01:34:13 2024
...
file_directory = '/Volumes/NO NAME/FS/Mempool Dumpster/March'
...
for day in range(1, 32):
    file_name = f"2024-03-{day:02d}.csv"  # Format day as 01, 02, etc.
...
if dataframes:
    ...
    # Customisation
    plt.title("Daily Distribution of Transactions (March 2024)", fontsize=14)
