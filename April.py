...
# -*- coding: utf-8 -*-
"""
Created on Wed Dec  4 01:34:14 2024
...
file_directory = '/Volumes/NO NAME/FS/Mempool Dumpster/April'
...
# Initialize a counter to track total rows across all CSVs
total_rows_in_files = 0

# Initialize lists for daily counts
daily_on_chain = []
daily_not_included = []
days = []
...
for day in range(1, 31):
    file_name = f"2024-04-{day:02d}.csv"  # Format day as 01, 02, etc.
...
if dataframes:
    ...
    # Customisation 2
    plt.title("Daily Distribution of Transactions (April 2024)", fontsize=14)
